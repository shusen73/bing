...
import matcapSunSource from '../models/matcaps/sun.png'
import matcapYellow2Source from '../models/matcaps/yellow2.png'
import matcapLeafSource from '../models/matcaps/leaf.png'

import matcapDarkbrownSource from '../models/matcaps/Darkbrown.png'
import matcapLightbrownSource from '../models/matcaps/lightbrown.png'
...
// Car default
import carDefaultChassisSource from '../models/car/default/bmw-chassis.glb'
import carDefaultWheelSource from '../models/car/default/bmw-wheel1.glb'
import carDefaultBackLightsBrakeSource from '../models/car/default/bmw-backLightsBrake.glb'
...
// Sunflower
import sunflowerBaseSource from '../models/sunflower.glb'
import sunflowerCollisionSourceSource from '../models/intro/b/collision.glb'

import messageBaseSource from '../models/message.glb'
import messageCollisionSource from '../models/messageCollision.glb'
...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'matcapSun', source: matcapSunSource, type: 'texture' },
            { name: 'matcapYellow2', source: matcapYellow2Source, type: 'texture' },
            { name: 'matcapDarkbrown', source: matcapDarkbrownSource, type: 'texture' },
            { name: 'matcapLightbrown', source: matcapLightbrownSource, type: 'texture' },
            { name: 'matcapLeaf', source: matcapLeafSource, type: 'texture' },
            ...
            // { name: 'lemonCollision', source: introBCollisionSource },

            // sunflower
            { name: 'sunflowerBase', source: sunflowerBaseSource },
            { name: 'sunflowerCollision', source: sunflowerBaseSource },

            { name: 'messageBase', source: messageBaseSource },
            { name: 'messageCollision', source: messageCollisionSource },
