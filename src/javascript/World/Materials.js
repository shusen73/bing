...
export default class Materials
{
    ...
    setShades()
    {
        ...
        // Leaf
        this.shades.items.leaf = new MatcapMaterial()
        this.shades.items.leaf.name = 'shadeLeaf'
        this.shades.items.leaf.uniforms.matcap.value = this.resources.items.matcapLeafTexture
        this.items.leaf = this.shades.items.leaf

        // Lightbrown
        this.shades.items.lightbrown = new MatcapMaterial()
        this.shades.items.lightbrown.name = 'shadeLightbrown'
        this.shades.items.lightbrown.uniforms.matcap.value = this.resources.items.matcapLightbrownTexture
        this.items.lightbrown = this.shades.items.lightbrown

        // Darkbrown
        this.shades.items.darkbrown = new MatcapMaterial()
        this.shades.items.darkbrown.name = 'shadeDarkbrown'
        this.shades.items.darkbrown.uniforms.matcap.value = this.resources.items.matcapDarkbrownTexture
        this.items.darkbrown = this.shades.items.darkbrown


        // Yellow2
        this.shades.items.yellow2 = new MatcapMaterial()
        this.shades.items.yellow2.name = 'shadeYellow2'
        this.shades.items.yellow2.uniforms.matcap.value = this.resources.items.matcapYellow2Texture
        this.items.yellow2 = this.shades.items.yellow2

        // Sun
        this.shades.items.sun = new MatcapMaterial()
        this.shades.items.sun.name = 'shadeSun'
        this.shades.items.sun.uniforms.matcap.value = this.resources.items.matcapSunTexture
        this.items.sun = this.shades.items.sun
