...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.chassisDepth = 2.59
        this.car.options.chassisOffset = new CANNON.Vec3(0, 0, 0.41)
        this.car.options.chassisMass = 20
        this.car.options.wheelFrontOffsetDepth = 0.955
        this.car.options.wheelBackOffsetDepth = - 0.685
        ...
        this.car.options.controlsAcceleratingSpeed = 0.5
